...
function renderInRange(days){
    ...
    if(myLineChart != null){
        // myLineChart.reset();
        // myLineChart.destroy();
        myLineChart.data.labels = date.slice(date.length - days);
        myLineChart.data.datasets[0].data = disc.slice(date.length - days);
        myLineChart.update();
    }
    else{    
            ...
            options: {
                ...
                animation: {
                    ...
                    onComplete: function (animation) {
                        ...
                        document.getElementById('readingDataDiv').style.display = "none";
                    }
                }
            }
        });
